...
import com.xwt.adapter.LoveListAdapter;
import com.xwt.adapter.MainListAdapter;
import com.xwt.database.DBManager;
import com.xwt.internetradio.R;
import com.xwt.service.RadioPlayService;
import com.xwt.util.Radio;
import com.xwt.util.RadioOperationInfo;
import com.xwt.view.DragLayout;
import com.xwt.view.ExitDialog;
import com.xwt.view.DragLayout.DragListener;
...
public class MainActivity extends Activity implements OnClickListener, OnItemClickListener
{
    ...
    public void onClick(View v)
    {
        if (v == radioControll)
        {
            if (IsPlay == false)
            {
                if (RadioPath == null)
                {
                    Toast.makeText(this, "请先选择一个电台", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    RadioPlay();
    ...
    private class RadioInfoChangeReceiver extends BroadcastReceiver
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            {
                radioNameView.setText("等待一下精彩马上开始");
            }
